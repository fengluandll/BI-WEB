...
class BigScreen extends PureComponent {
    ...
    pullSynchronization = () => {
        ...
        this.props.dispatch({
            type: 'bigScreen/pullSynchronizationTab',
            payload: {
                id,
                callback: (success) => {
                    if (success) {
