import { list as dlList, deleteTable } from '../services/dl';
...
export default {
  ...
  effects: {
    *fetch({ payload: { name, page, pageSize } }, { call, put }) {
      ...
      const response = yield call(dlList, { name, page, pageSize });
      const data = response.data;
      yield put({ type: 'save', payload: { data } });
    },
    *deleteTable({ payload: { id, name, page, pageSize } }, { call, put }) {
      yield call(deleteTable, { id });
      yield put({
        type: 'changeLoading',
        payload: true,
      });
